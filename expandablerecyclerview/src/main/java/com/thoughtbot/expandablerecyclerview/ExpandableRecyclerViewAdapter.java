...
public abstract class ExpandableRecyclerViewAdapter<GVH extends GroupViewHolder, CVH extends ChildViewHolder>
  ...
  public ExpandableRecyclerViewAdapter(List<? extends ExpandableGroup> groups, final GridLayoutManager gridLayoutManager) {
  ...
  private boolean isSection(int position) {
    ...
    return listPos.type == ExpandableListPosition.GROUP;
  }
