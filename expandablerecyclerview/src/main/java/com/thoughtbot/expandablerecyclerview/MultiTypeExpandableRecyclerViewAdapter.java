...
public abstract class MultiTypeExpandableRecyclerViewAdapter<GVH extends GroupViewHolder, CVH extends ChildViewHolder>
  ...
  public MultiTypeExpandableRecyclerViewAdapter(List<? extends ExpandableGroup> groups, final GridLayoutManager gridLayoutManager) {
    super(groups, gridLayoutManager);
  }
